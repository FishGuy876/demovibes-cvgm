...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('webview_link', (
            ...
            ('submitted_by', models.ForeignKey(orm['auth.User'], related_name="label_submittedby", null=True, blank=True)),
            ...
            ('url_cat', models.ForeignKey(orm.LinkCategory, verbose_name="Link Category")),
            ('priority', models.BooleanField(default=False, db_index=True)),
            ('approved_by', models.ForeignKey(orm['auth.User'], related_name="label_approvedby", null=True, blank=True)),
        ...
        db.send_create_signal('webview', ['Link'])
        
        # Adding model 'LinkCategory'
        db.create_table('webview_linkcategory', (
        ...
        db.send_create_signal('webview', ['LinkCategory'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Link'
        db.delete_table('webview_link')
        
        # Deleting model 'LinkCategory'
        db.delete_table('webview_linkcategory')
