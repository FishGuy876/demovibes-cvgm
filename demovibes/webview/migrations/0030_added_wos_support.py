...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('webview_song', 'wos_id', models.IntegerField(null=True, verbose_name="W.O.S. ID", blank=True))
        
        # Changing field 'Userprofile.location'
        db.alter_column('webview_userprofile', 'location', models.CharField(max_length=40, verbose_name="Hometown Location", blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Userprofile.location'
        db.alter_column('webview_userprofile', 'location', models.CharField(max_length=40, verbose_name="Geographical Location", blank=True))
    ...
    models = {
        ...
        'webview.song': {
            ...
            'wos_id': ('models.IntegerField', [], {'null': 'True', 'verbose_name': '"W.O.S. ID"', 'blank': 'True'}),
