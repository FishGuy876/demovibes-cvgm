...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Userprofile.paginate_favorites'
        db.add_column('webview_userprofile', 'paginate_favorites', models.BooleanField(default=True))
        
        # Adding field 'Userprofile.last_activity'
        db.add_column('webview_userprofile', 'last_activity', models.DateTimeField(null=True, blank=True))
        
        # Changing field 'Userprofile.pm_accepted_upload'
        db.alter_column('webview_userprofile', 'pm_accepted_upload', models.BooleanField(default=True, verbose_name="Send PM on accepted upload"))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Userprofile.paginate_favorites'
        db.delete_column('webview_userprofile', 'paginate_favorites')
        
        # Deleting field 'Userprofile.last_activity'
        db.delete_column('webview_userprofile', 'last_activity')
        
        # Changing field 'Userprofile.pm_accepted_upload'
        db.alter_column('webview_userprofile', 'pm_accepted_upload', models.BooleanField(default=True, verbose_name="Send PM when song upload is accepted"))
