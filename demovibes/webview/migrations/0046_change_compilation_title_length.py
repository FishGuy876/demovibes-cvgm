...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('webview_compilation', 'name', self.gf('django.db.models.fields.CharField')(max_length=60, unique=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Compilation.name'
        db.alter_column('webview_compilation', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30))
    ...
    models = {
        ...
        'webview.compilation': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '60', 'unique': 'True', 'db_index': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 11, 15, 19, 29, 412901)'}),
