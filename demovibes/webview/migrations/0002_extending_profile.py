...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Userprofile.infoline'
        db.add_column('webview_userprofile', 'infoline', models.CharField(max_length=50, blank=True))
        
        # Adding field 'Userprofile.visible_to'
        db.add_column('webview_userprofile', 'visible_to', models.CharField(default="A", max_length=1))
        
        # Changing field 'Userprofile.country'
        db.alter_column('webview_userprofile', 'country', models.CharField(max_length=10, verbose_name="Country code", blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Userprofile.infoline'
        db.delete_column('webview_userprofile', 'infoline')
        
        # Deleting field 'Userprofile.visible_to'
        db.delete_column('webview_userprofile', 'visible_to')
        
        # Changing field 'Userprofile.country'
        db.alter_column('webview_userprofile', 'country', models.CharField(max_length=10, blank=True))
