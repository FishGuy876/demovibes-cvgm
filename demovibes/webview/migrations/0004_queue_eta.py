...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Queue.eta'
        db.add_column('webview_queue', 'eta', models.DateTimeField(null=True, blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Queue.eta'
        db.delete_column('webview_queue', 'eta')
