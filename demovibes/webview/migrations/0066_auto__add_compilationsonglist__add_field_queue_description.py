...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CompilationSongList'
        db.create_table('webview_compilationsonglist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('song', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webview.Song'])),
            ('compilation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webview.Compilation'])),
            ('num', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('webview', ['CompilationSongList'])

        # Adding field 'Queue.description'
        db.add_column('webview_queue', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'CompilationSongList'
        db.delete_table('webview_compilationsonglist')

        # Deleting field 'Queue.description'
        db.delete_column('webview_queue', 'description')
    ...
    models = {
        ...
        'webview.compilationsonglist': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'num': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 25, 3, 50, 0, 703854)'}),
