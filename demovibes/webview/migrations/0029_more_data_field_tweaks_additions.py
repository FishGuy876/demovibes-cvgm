...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Userprofile.icq_id'
        db.add_column('webview_userprofile', 'icq_id', models.CharField(max_length=40, verbose_name="ICQ Number", blank=True))
        
        # Adding field 'Compilation.zxdemo_id'
        db.add_column('webview_compilation', 'zxdemo_id', models.IntegerField(null=True, verbose_name="ZXDemo ID", blank=True))
        
        # Adding field 'Compilation.projecttwosix_id'
        db.add_column('webview_compilation', 'projecttwosix_id', models.IntegerField(null=True, verbose_name="Project2612 ID", blank=True))
        
        # Adding field 'Song.projecttwosix_id'
        db.add_column('webview_song', 'projecttwosix_id', models.IntegerField(null=True, verbose_name="Project2612 ID", blank=True))
        
        # Adding field 'Userprofile.yahoo_id'
        db.add_column('webview_userprofile', 'yahoo_id', models.CharField(max_length=40, verbose_name="Yahoo! ID", blank=True))
        
        # Adding field 'Userprofile.aol_id'
        db.add_column('webview_userprofile', 'aol_id', models.CharField(max_length=40, verbose_name="AOL IM", blank=True))
        
        # Adding field 'Song.hvsc_url'
        db.add_column('webview_song', 'hvsc_url', models.URLField(verbose_name="HVSC Link", blank=True))
        
        # Changing field 'Song.file'
        db.alter_column('webview_song', 'file', models.FileField(verbose_name="File"))
        
        # Changing field 'Song.title'
        db.alter_column('webview_song', 'title', models.CharField(max_length=80, verbose_name="* Song Name", db_index=True))
        
        # Changing field 'Song.zxdemo_id'
        db.alter_column('webview_song', 'zxdemo_id', models.IntegerField(null=True, verbose_name="ZXDemo ID", blank=True))
        
        # Changing field 'Song.lemon_id'
        db.alter_column('webview_song', 'lemon_id', models.IntegerField(null=True, verbose_name="Lemon64 ID", blank=True))
        
        # Changing field 'Userprofile.web_page'
        db.alter_column('webview_userprofile', 'web_page', models.URLField(verbose_name="Website", blank=True))
        
        # Changing field 'Userprofile.info'
        db.alter_column('webview_userprofile', 'info', models.TextField(verbose_name="Profile Info", blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Userprofile.icq_id'
        db.delete_column('webview_userprofile', 'icq_id')
        
        # Deleting field 'Compilation.zxdemo_id'
        db.delete_column('webview_compilation', 'zxdemo_id')
        
        # Deleting field 'Compilation.projecttwosix_id'
        db.delete_column('webview_compilation', 'projecttwosix_id')
        
        # Deleting field 'Song.projecttwosix_id'
        db.delete_column('webview_song', 'projecttwosix_id')
        
        # Deleting field 'Userprofile.yahoo_id'
        db.delete_column('webview_userprofile', 'yahoo_id')
        
        # Deleting field 'Userprofile.aol_id'
        db.delete_column('webview_userprofile', 'aol_id')
        
        # Deleting field 'Song.hvsc_url'
        db.delete_column('webview_song', 'hvsc_url')
        
        # Changing field 'Song.file'
        db.alter_column('webview_song', 'file', models.FileField())
        
        # Changing field 'Song.title'
        db.alter_column('webview_song', 'title', models.CharField(max_length=80, db_index=True))
        
        # Changing field 'Song.zxdemo_id'
        db.alter_column('webview_song', 'zxdemo_id', models.IntegerField(default=0, verbose_name="ZXDemo ID"))
        
        # Changing field 'Song.lemon_id'
        db.alter_column('webview_song', 'lemon_id', models.IntegerField(default=0, verbose_name="Lemon64 ID"))
        
        # Changing field 'Userprofile.web_page'
        db.alter_column('webview_userprofile', 'web_page', models.URLField(blank=True))
        
        # Changing field 'Userprofile.info'
        db.alter_column('webview_userprofile', 'info', models.TextField(blank=True))
