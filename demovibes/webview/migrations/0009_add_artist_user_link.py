...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Artist.link_to_user'
        db.add_column('webview_artist', 'link_to_user', models.OneToOneField(orm['auth.User'], null=True, blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Artist.link_to_user'
        db.delete_column('webview_artist', 'link_to_user_id')
