...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Artist.is_deceased'
        db.add_column('webview_artist', 'is_deceased', models.BooleanField(default=False, verbose_name="Deceased?"))
        
        # Adding field 'Artist.deceased_date'
        db.add_column('webview_artist', 'deceased_date', models.DateField(null=True, verbose_name="Date Of Death", blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Artist.is_deceased'
        db.delete_column('webview_artist', 'is_deceased')
        
        # Deleting field 'Artist.deceased_date'
        db.delete_column('webview_artist', 'deceased_date')
