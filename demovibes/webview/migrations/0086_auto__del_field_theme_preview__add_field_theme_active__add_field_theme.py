...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Theme.preview'
        db.delete_column('webview_theme', 'preview')

        # Adding field 'Theme.active'
        db.add_column('webview_theme', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Theme.creator'
        db.add_column('webview_theme', 'creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'ScreenshotObjectLink.is_main'
        db.add_column('webview_screenshotobjectlink', 'is_main', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Theme.preview'
        db.add_column('webview_theme', 'preview', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Theme.active'
        db.delete_column('webview_theme', 'active')

        # Deleting field 'Theme.creator'
        db.delete_column('webview_theme', 'creator_id')

        # Deleting field 'ScreenshotObjectLink.is_main'
        db.delete_column('webview_screenshotobjectlink', 'is_main')
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 18, 17, 49, 20, 884659)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 18, 17, 49, 20, 873065)'}),
