...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GenericLink.value'
        db.alter_column('webview_genericlink', 'value', self.gf('django.db.models.fields.CharField')(max_length=80))


    def backwards(self, orm):
        
        # Changing field 'GenericLink.value'
        db.alter_column('webview_genericlink', 'value', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 11, 20, 19, 39, 446051)'}),
