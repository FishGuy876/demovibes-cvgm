...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Userprofile.last_changed'
        db.add_column('webview_userprofile', 'last_changed', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 5, 1, 18, 36, 4, 538702)), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Userprofile.last_changed'
        db.delete_column('webview_userprofile', 'last_changed')
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 5, 1, 18, 36, 4, 538702)'}),
