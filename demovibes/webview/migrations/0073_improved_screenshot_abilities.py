...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Song', fields ['status']
        db.create_index('webview_song', ['status'])

        # Deleting field 'Screenshot.active'
        db.delete_column('webview_screenshot', 'active')

        # Adding field 'Screenshot.status'
        db.add_column('webview_screenshot', 'status', self.gf('django.db.models.fields.CharField')(default='A', max_length=1, db_index=True), keep_default=False)

        # Adding field 'Screenshot.thumbnail'
        db.add_column('webview_screenshot', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Changing field 'Screenshot.name'
        db.alter_column('webview_screenshot', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=80))


    def backwards(self, orm):
        
        # Removing index on 'Song', fields ['status']
        db.delete_index('webview_song', ['status'])
        ...
        # Adding field 'Screenshot.active'
        db.add_column('webview_screenshot', 'active', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True), keep_default=False)

        # Deleting field 'Screenshot.status'
        db.delete_column('webview_screenshot', 'status')

        # Deleting field 'Screenshot.thumbnail'
        db.delete_column('webview_screenshot', 'thumbnail')

        # Changing field 'Screenshot.name'
        db.alter_column('webview_screenshot', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=70))
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 28, 13, 35, 53, 986470)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'webview.song': {
            ...
            'screenshot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['webview.Screenshot']", 'null': 'True', 'blank': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 28, 13, 35, 53, 957498)'}),
