...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('webview_group', 'status', models.CharField(default='A', max_length=1))
        
        # Adding field 'Artist.status'
        db.add_column('webview_artist', 'status', models.CharField(default='A', max_length=1))
        
        # Changing field 'Oneliner.message'
        db.alter_column('webview_oneliner', 'message', models.CharField(max_length=256))
    ...
    def backwards(self, orm):
        ...
        db.delete_column('webview_group', 'status')
        
        # Deleting field 'Artist.status'
        db.delete_column('webview_artist', 'status')
        
        # Changing field 'Oneliner.message'
        db.alter_column('webview_oneliner', 'message', models.CharField(max_length=128))
