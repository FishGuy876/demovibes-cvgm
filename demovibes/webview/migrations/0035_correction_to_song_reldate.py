...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Song.release_date'
        db.alter_column('webview_song', 'release_date', models.DateField(null=True, verbose_name="Release Date", blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Song.release_date'
        db.alter_column('webview_song', 'release_date', models.DateTimeField(null=True, verbose_name="Release Date", blank=True))
