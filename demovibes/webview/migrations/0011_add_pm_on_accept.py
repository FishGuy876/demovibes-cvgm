...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Userprofile.pm_accepted_upload'
        db.add_column('webview_userprofile', 'pm_accepted_upload', models.BooleanField(default=True, verbose_name="Send PM when song upload is accepted"))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Userprofile.pm_accepted_upload'
        db.delete_column('webview_userprofile', 'pm_accepted_upload')
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'pm_accepted_upload': ('models.BooleanField', [], {'default': 'True', 'verbose_name': '"Send PM when song upload is accepted"'}),
