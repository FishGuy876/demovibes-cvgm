...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScreenshotObjectLink'
        db.create_table('webview_screenshotobjectlink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webview.Screenshot'])),
        ))
        db.send_create_signal('webview', ['ScreenshotObjectLink'])

        # Changing field 'Screenshot.name'
        db.alter_column('webview_screenshot', 'name', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))


    def backwards(self, orm):
        
        # Deleting model 'ScreenshotObjectLink'
        db.delete_table('webview_screenshotobjectlink')

        # Changing field 'Screenshot.name'
        db.alter_column('webview_screenshot', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20))
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 19, 29, 27, 301106)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 19, 29, 27, 259620)'}),
