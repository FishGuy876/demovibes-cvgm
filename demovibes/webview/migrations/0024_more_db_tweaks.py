...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.last_updated'
        db.add_column('webview_group', 'last_updated', models.DateTimeField(null=True, blank=True))
        
        # Adding field 'Artist.last_updated'
        db.add_column('webview_artist', 'last_updated', models.DateTimeField(null=True, blank=True))
        
        # Adding field 'Compilation.last_updated'
        db.add_column('webview_compilation', 'last_updated', models.DateTimeField(null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_column('webview_group', 'last_updated')
        
        # Deleting field 'Artist.last_updated'
        db.delete_column('webview_artist', 'last_updated')
        
        # Deleting field 'Compilation.last_updated'
        db.delete_column('webview_compilation', 'last_updated')
