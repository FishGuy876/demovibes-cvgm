...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Song.wos_id'
        db.delete_column('webview_song', 'wos_id')

        # Deleting field 'Song.ytvidid'
        db.delete_column('webview_song', 'ytvidid')

        # Deleting field 'Song.cvgm_id'
        db.delete_column('webview_song', 'cvgm_id')

        # Deleting field 'Song.necta_id'
        db.delete_column('webview_song', 'necta_id')

        # Deleting field 'Song.platform'
        db.delete_column('webview_song', 'platform_id')

        # Deleting field 'Song.dtv_id'
        db.delete_column('webview_song', 'dtv_id')

        # Deleting field 'Song.hvsc_url'
        db.delete_column('webview_song', 'hvsc_url')

        # Deleting field 'Song.remix_of_id'
        db.delete_column('webview_song', 'remix_of_id')

        # Deleting field 'Song.ytvidoffset'
        db.delete_column('webview_song', 'ytvidoffset')

        # Deleting field 'Song.screenshot'
        db.delete_column('webview_song', 'screenshot_id')

        # Deleting field 'Song.zxdemo_id'
        db.delete_column('webview_song', 'zxdemo_id')

        # Deleting field 'Song.al_id'
        db.delete_column('webview_song', 'al_id')

        # Deleting field 'Song.info'
        db.delete_column('webview_song', 'info')

        # Deleting field 'Song.release_year'
        db.delete_column('webview_song', 'release_year')

        # Deleting field 'Song.type'
        db.delete_column('webview_song', 'type_id')

        # Deleting field 'Song.pouetid'
        db.delete_column('webview_song', 'pouetid')

        # Deleting field 'Song.hol_id'
        db.delete_column('webview_song', 'hol_id')

        # Deleting field 'Song.projecttwosix_id'
        db.delete_column('webview_song', 'projecttwosix_id')

        # Deleting field 'Song.lemon_id'
        db.delete_column('webview_song', 'lemon_id')

        # Removing M2M table for field labels on 'Song'
        db.delete_table('webview_song_labels')

        # Removing M2M table for field artists on 'Song'
        db.delete_table('webview_song_artists')

        # Removing M2M table for field groups on 'Song'
        db.delete_table('webview_song_groups')

        # Deleting field 'SongMetaData.screenshot'
        db.delete_column('webview_songmetadata', 'screenshot_id')

        # Adding field 'Screenshot.content_type'
        db.add_column('webview_screenshot', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['contenttypes.ContentType']), keep_default=False)

        # Adding field 'Screenshot.object_id'
        db.add_column('webview_screenshot', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Song.wos_id'
        db.add_column('webview_song', 'wos_id', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True), keep_default=False)

        # Adding field 'Song.ytvidid'
        db.add_column('webview_song', 'ytvidid', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'Song.cvgm_id'
        db.add_column('webview_song', 'cvgm_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Song.necta_id'
        db.add_column('webview_song', 'necta_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Song.platform'
        db.add_column('webview_song', 'platform', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webview.SongPlatform'], null=True, blank=True), keep_default=False)

        # Adding field 'Song.dtv_id'
        db.add_column('webview_song', 'dtv_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Song.hvsc_url'
        db.add_column('webview_song', 'hvsc_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Song.remix_of_id'
        db.add_column('webview_song', 'remix_of_id', self.gf('django.db.models.fields.IntegerField')(blank=True, null=True, db_index=True), keep_default=False)

        # Adding field 'Song.ytvidoffset'
        db.add_column('webview_song', 'ytvidoffset', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Song.screenshot'
        db.add_column('webview_song', 'screenshot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webview.Screenshot'], null=True, blank=True), keep_default=False)

        # Adding field 'Song.zxdemo_id'
        db.add_column('webview_song', 'zxdemo_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Song.al_id'
        db.add_column('webview_song', 'al_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Song.info'
        db.add_column('webview_song', 'info', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Song.release_year'
        db.add_column('webview_song', 'release_year', self.gf('django.db.models.fields.CharField')(blank=True, max_length='4', null=True, db_index=True), keep_default=False)

        # Adding field 'Song.type'
        db.add_column('webview_song', 'type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webview.SongType'], null=True, blank=True), keep_default=False)

        # Adding field 'Song.pouetid'
        db.add_column('webview_song', 'pouetid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Song.hol_id'
        db.add_column('webview_song', 'hol_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Song.projecttwosix_id'
        db.add_column('webview_song', 'projecttwosix_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Song.lemon_id'
        db.add_column('webview_song', 'lemon_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding M2M table for field labels on 'Song'
        db.create_table('webview_song_labels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('song', models.ForeignKey(orm['webview.song'], null=False)),
            ('label', models.ForeignKey(orm['webview.label'], null=False))
        ))
        db.create_unique('webview_song_labels', ['song_id', 'label_id'])

        # Adding M2M table for field artists on 'Song'
        db.create_table('webview_song_artists', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('song', models.ForeignKey(orm['webview.song'], null=False)),
            ('artist', models.ForeignKey(orm['webview.artist'], null=False))
        ))
        db.create_unique('webview_song_artists', ['song_id', 'artist_id'])

        # Adding M2M table for field groups on 'Song'
        db.create_table('webview_song_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('song', models.ForeignKey(orm['webview.song'], null=False)),
            ('group', models.ForeignKey(orm['webview.group'], null=False))
        ))
        db.create_unique('webview_song_groups', ['song_id', 'group_id'])

        # Adding field 'SongMetaData.screenshot'
        db.add_column('webview_songmetadata', 'screenshot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webview.Screenshot'], null=True, blank=True), keep_default=False)

        # Deleting field 'Screenshot.content_type'
        db.delete_column('webview_screenshot', 'content_type_id')

        # Deleting field 'Screenshot.object_id'
        db.delete_column('webview_screenshot', 'object_id')
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 1, 17, 32, 11, 925290)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 1, 17, 32, 11, 882818)'}),
