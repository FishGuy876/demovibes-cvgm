...
class Migration(DataMigration):
    ...
    def __update (self):
        for m in [M.Group, M.Label, M.Artist, M.Screenshot, M.Song, M.Compilation]:
            print " ... Updating startswith field of objects of", m.__name__, "model"
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 9, 9, 40, 56, 469752)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.song': {
            ...
            'rnd': ('django.db.models.fields.IntegerField', [], {'default': '1332122281', 'db_index': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 9, 9, 40, 56, 455947)'}),
