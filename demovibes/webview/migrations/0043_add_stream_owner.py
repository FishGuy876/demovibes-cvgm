...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RadioStream.user'
        db.add_column('webview_radiostream', 'user', models.ForeignKey(orm['auth.User'], null=True))
        
        # Changing field 'RadioStream.description'
        db.alter_column('webview_radiostream', 'description', models.TextField(blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'RadioStream.user'
        db.delete_column('webview_radiostream', 'user_id')
        
        # Changing field 'RadioStream.description'
        db.alter_column('webview_radiostream', 'description', models.TextField())
