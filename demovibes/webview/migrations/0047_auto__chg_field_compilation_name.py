...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Song', fields ['remix_of_id']
        db.create_index('webview_song', ['remix_of_id'])

        # Changing field 'Compilation.name'
        db.alter_column('webview_compilation', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=80))


    def backwards(self, orm):
        
        # Removing index on 'Song', fields ['remix_of_id']
        db.delete_index('webview_song', ['remix_of_id'])

        # Changing field 'Compilation.name'
        db.alter_column('webview_compilation', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=60))
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 22, 3, 0, 38, 34625)'}),
