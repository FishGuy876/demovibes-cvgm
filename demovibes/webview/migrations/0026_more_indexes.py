...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.alter_column('webview_song', 'remix_of_id', models.IntegerField(null=True, verbose_name='SongID of original mix', blank=True))
    ...
    models = {
        ...
        'webview.song': {
            ...
            'remix_of_id': ('models.IntegerField', [], {'null': 'True', 'verbose_name': "'SongID of original mix'", 'blank': 'True'}),
