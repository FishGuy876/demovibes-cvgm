...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Compilation'
        db.create_table('webview_compilation', (
            ...
            ('rel_date', models.CharField(max_length=30)),
        ...
        db.send_create_signal('webview', ['Compilation'])
        
        # Adding model 'ArtistVote'
        db.create_table('webview_artistvote', (
        ...
        db.send_create_signal('webview', ['ArtistVote'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Compilation'
        db.delete_table('webview_compilation')
        
        # Deleting model 'ArtistVote'
        db.delete_table('webview_artistvote')
