...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for song in orm.Song.objects.all():
            print "Doing", song.title
            s = orm.SongMetaData.objects.filter(song=song)[0]
            s.ytvidid = song.ytvidid
            s.ytvidoffset = song.ytvidoffset
            s.pouetid = song.pouetid
            s.save()
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 28, 22, 38, 56, 963735)'}),
