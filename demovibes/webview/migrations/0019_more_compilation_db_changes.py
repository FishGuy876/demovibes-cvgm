...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CompilationVote'
        db.create_table('webview_compilationvote', (
            ('vote', models.IntegerField(default=0)),
            ('comp', models.ForeignKey(orm.Compilation)),
            ('added', models.DateTimeField(auto_now_add=True)),
            ('id', models.AutoField(primary_key=True)),
            ('user', models.ForeignKey(orm['auth.User'])),
        ))
        db.send_create_signal('webview', ['CompilationVote'])
        
        # Adding field 'Compilation.media_format'
        db.add_column('webview_compilation', 'media_format', models.CharField(max_length=30, blank=True))
        
        # Adding field 'Compilation.pouet'
        db.add_column('webview_compilation', 'pouet', models.IntegerField(null=True, blank=True))
        
        # Adding ManyToManyField 'Compilation.prod_artists'
        db.create_table('webview_compilation_prod_artists', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('compilation', models.ForeignKey(Compilation, null=False)),
            ('artist', models.ForeignKey(Artist, null=False))
        ))
        
        # Adding field 'Compilation.bar_code'
        db.add_column('webview_compilation', 'bar_code', models.CharField(max_length=30, blank=True))
        
        # Adding ManyToManyField 'Compilation.prod_groups'
        db.create_table('webview_compilation_prod_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('compilation', models.ForeignKey(Compilation, null=False)),
        ...
        db.alter_column('webview_compilation', 'rel_date', models.DateField(null=True, blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'CompilationVote'
        db.delete_table('webview_compilationvote')
        
        # Deleting field 'Compilation.media_format'
        db.delete_column('webview_compilation', 'media_format')
        
        # Deleting field 'Compilation.pouet'
        db.delete_column('webview_compilation', 'pouet')
        
        # Dropping ManyToManyField 'Compilation.prod_artists'
        db.delete_table('webview_compilation_prod_artists')
        
        # Deleting field 'Compilation.bar_code'
        db.delete_column('webview_compilation', 'bar_code')
        
        # Dropping ManyToManyField 'Compilation.prod_groups'
        db.delete_table('webview_compilation_prod_groups')
