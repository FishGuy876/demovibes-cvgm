...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PrivateMessage.visible'
        db.add_column('webview_privatemessage', 'visible', models.BooleanField(default=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'PrivateMessage.visible'
        db.delete_column('webview_privatemessage', 'visible')
