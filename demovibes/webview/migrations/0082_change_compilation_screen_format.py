...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Screenshot.type'
        db.add_column('webview_screenshot', 'type', self.gf('django.db.models.fields.CharField')(default='0', max_length=1, db_index=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Screenshot.type'
        db.delete_column('webview_screenshot', 'type')

        # Changing field 'Screenshot.name'
        db.alter_column('webview_screenshot', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30))
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 5, 9, 19, 6, 471472)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 5, 9, 19, 6, 446042)'}),
