...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Userprofile.show_youtube'
        db.add_column('webview_userprofile', 'show_youtube', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Userprofile.show_youtube'
        db.delete_column('webview_userprofile', 'show_youtube')
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 15, 23, 50, 39, 174490)'}),
