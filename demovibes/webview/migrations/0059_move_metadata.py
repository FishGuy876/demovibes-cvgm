...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for song in orm.Song.objects.all():
            s = orm.SongMetaData(
                ...
                type = song.type,
                remix_of_id = song.remix_of_id
            )
            s.save()
            s.artists = song.artists.all()
            s.labels = song.labels.all()
            s.groups = song.groups.all()
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 28, 3, 1, 38, 772188)'}),
