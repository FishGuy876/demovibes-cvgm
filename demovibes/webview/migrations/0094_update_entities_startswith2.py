...
# We need to use current models, not a frozen stuff
...
class Migration(DataMigration):
    ...
    def __update (self):
        for m in [M.Group, M.Label, M.Artist, M.Screenshot, M.Song, M.Compilation]:
            print " ... Updating startswith field of objects of", m.__name__, "model having startswith=#"

            for obj in m.objects.filter (startswith = '#'):
                obj.save ()
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 9, 10, 40, 33, 498856)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.song': {
            ...
            'rnd': ('django.db.models.fields.IntegerField', [], {'default': '1596977003', 'db_index': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 9, 10, 40, 33, 485025)'}),
