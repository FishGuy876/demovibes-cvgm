...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('webview_userprofile', 'twitter_id', models.CharField(max_length=32, verbose_name="Twitter ID", blank=True))
        
        # Adding field 'Song.necta_id'
        db.add_column('webview_song', 'necta_id', models.IntegerField(null=True, verbose_name="Necta SongID", blank=True))
        
        # Adding field 'Artist.twitter_id'
        db.add_column('webview_artist', 'twitter_id', models.CharField(max_length=32, verbose_name="Twitter ID", blank=True))
        
        # Adding field 'Song.cvgm_id'
        db.add_column('webview_song', 'cvgm_id', models.IntegerField(null=True, verbose_name="CVGM SongID", blank=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_column('webview_userprofile', 'twitter_id')
        
        # Deleting field 'Song.necta_id'
        db.delete_column('webview_song', 'necta_id')
        
        # Deleting field 'Artist.twitter_id'
        db.delete_column('webview_artist', 'twitter_id')
