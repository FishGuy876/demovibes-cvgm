...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for song in orm.Song.objects.all ():
            song.rnd = M.int_rnd_val ()
            song.save ()

    def backwards(self, orm):
        "Write your backwards methods here."

        pass # Who cares about random numbers?
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 26, 12, 6, 5, 313515)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.song': {
            ...
            'rnd': ('django.db.models.fields.IntegerField', [], {'default': 4, 'db_index': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 26, 12, 6, 5, 299555)'}),
