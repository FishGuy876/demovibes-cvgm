...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('webview_groupvote', (
        ...
        db.send_create_signal('webview', ['GroupVote'])
        
        # Adding field 'Artist.artist_pic'
        db.add_column('webview_artist', 'artist_pic', models.ImageField(null=True, upload_to='media/artists', blank=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('webview_groupvote')
        
        # Deleting field 'Artist.artist_pic'
        db.delete_column('webview_artist', 'artist_pic')
