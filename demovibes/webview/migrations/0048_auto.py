...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index('webview_userprofile', ['last_activity'])


    def backwards(self, orm):
        
        # Removing index on 'Userprofile', fields ['last_activity']
        db.delete_index('webview_userprofile', ['last_activity'])
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 22, 3, 33, 52, 6303)'}),
