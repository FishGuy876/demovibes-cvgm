...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Screenshot.object_id'
        raise RuntimeError("Cannot reverse this migration. 'Screenshot.object_id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Screenshot.content_type'
        raise RuntimeError("Cannot reverse this migration. 'Screenshot.content_type' and its values cannot be restored.")
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 19, 39, 38, 751373)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'webview.screenshotobjectlink': {
            'Meta': {'object_name': 'ScreenshotObjectLink'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 19, 39, 38, 733514)'}),
