...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Screenshot.name': 40 -> 100 characters (unique index is rebuilt)
        db.alter_column('webview_screenshot', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Screenshot.name' back to 40 characters. MySQL truncates any longer names,
        # and two names that then become equal will make the unique index fail.
        db.alter_column('webview_screenshot', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40))
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 24, 1, 32, 15, 188942)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.song': {
            ...
            'rnd': ('django.db.models.fields.IntegerField', [], {'default': '335821826', 'db_index': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 24, 1, 32, 15, 177872)'}),
            'last_ip': ('django.db.models.fields.IPAddressField', [], {'default': 'None', 'max_length': '15', 'null': 'True', 'blank': 'True'}),
