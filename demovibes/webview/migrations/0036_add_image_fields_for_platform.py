...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SongPlatform.symbol'
        db.add_column('webview_songplatform', 'symbol', models.ImageField(null=True, upload_to='media/platform/symbol', blank=True))
        
        # Adding field 'SongPlatform.image'
        db.add_column('webview_songplatform', 'image', models.ImageField(null=True, upload_to='media/platform/image', blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SongPlatform.symbol'
        db.delete_column('webview_songplatform', 'symbol')
        
        # Deleting field 'SongPlatform.image'
        db.delete_column('webview_songplatform', 'image')
