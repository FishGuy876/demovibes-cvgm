...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('webview_userprofile', 'real_name', models.CharField(max_length=40, verbose_name="Real Name", blank=True))
        ...
        db.alter_column('webview_artist', 'artist_pic', models.ImageField(null=True, verbose_name="Picture", blank=True))
        
        # Changing field 'Artist.webpage'
        db.alter_column('webview_artist', 'webpage', models.URLField(verbose_name="Website", blank=True))
        
        # Changing field 'Artist.name'
        db.alter_column('webview_artist', 'name', models.CharField(max_length=64, verbose_name="Name", blank=True))
    ...
    def backwards(self, orm):
        ...
        db.delete_column('webview_userprofile', 'real_name')
        
        # Changing field 'Song.title'
        db.alter_column('webview_song', 'title', models.CharField(max_length=64, db_index=True))
        
        # Changing field 'Artist.handle'
        db.alter_column('webview_artist', 'handle', models.CharField(max_length=64, unique=True, db_index=True))
        
        # Changing field 'Artist.artist_pic'
        db.alter_column('webview_artist', 'artist_pic', models.ImageField(null=True, blank=True))
        
        # Changing field 'Artist.webpage'
        db.alter_column('webview_artist', 'webpage', models.URLField(blank=True))
        
        # Changing field 'Artist.name'
        db.alter_column('webview_artist', 'name', models.CharField(max_length=64, blank=True))
