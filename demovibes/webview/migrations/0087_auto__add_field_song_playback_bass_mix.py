...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.playback_bass_mix'
        db.add_column('webview_song', 'playback_bass_mix', self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Song.playback_bass_mix'
        db.delete_column('webview_song', 'playback_bass_mix')
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 14, 22, 58, 19, 993614)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 14, 22, 58, 19, 969853)'}),
