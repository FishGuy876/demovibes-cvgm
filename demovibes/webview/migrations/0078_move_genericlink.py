...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for ss in orm.Screenshot.objects.all():
            sl = orm.ScreenshotObjectLink.objects.create(content_type = ss.content_type, object_id=ss.object_id, image=ss)
            print ss
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 19, 30, 3, 938764)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 19, 30, 3, 917544)'}),
