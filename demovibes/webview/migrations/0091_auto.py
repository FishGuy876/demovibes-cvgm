...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Song', fields ['rnd']
        db.create_index('webview_song', ['rnd'])


    def backwards(self, orm):
        
        # Removing index on 'Song', fields ['rnd']
        db.delete_index('webview_song', ['rnd'])
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 26, 11, 54, 51, 208844)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.song': {
            ...
            'rnd': ('django.db.models.fields.IntegerField', [], {'default': '-1593210274', 'db_index': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 26, 11, 54, 51, 195715)'}),
