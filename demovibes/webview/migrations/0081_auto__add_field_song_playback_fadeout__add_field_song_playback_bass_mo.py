...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.playback_fadeout'
        db.add_column('webview_song', 'playback_fadeout', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Song.playback_bass_mode'
        db.add_column('webview_song', 'playback_bass_mode', self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True), keep_default=False)

        # Adding field 'Song.playback_bass_inter'
        db.add_column('webview_song', 'playback_bass_inter', self.gf('django.db.models.fields.CharField')(default='', max_length=6, blank=True), keep_default=False)

        # Adding field 'Song.playback_bass_ramp'
        db.add_column('webview_song', 'playback_bass_ramp', self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Song.playback_fadeout'
        db.delete_column('webview_song', 'playback_fadeout')

        # Deleting field 'Song.playback_bass_mode'
        db.delete_column('webview_song', 'playback_bass_mode')

        # Deleting field 'Song.playback_bass_inter'
        db.delete_column('webview_song', 'playback_bass_inter')

        # Deleting field 'Song.playback_bass_ramp'
        db.delete_column('webview_song', 'playback_bass_ramp')
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 4, 0, 49, 12, 453840)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'webview.song': {
            ...
            'playback_bass_mode': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True'}),
            'playback_bass_ramp': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 4, 0, 49, 12, 436083)'}),
