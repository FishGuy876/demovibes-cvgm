...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Song.playback_bass_ramp'
        db.alter_column('webview_song', 'playback_bass_ramp', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Song.playback_bass_mode'
        db.alter_column('webview_song', 'playback_bass_mode', self.gf('django.db.models.fields.CharField')(max_length=4))


    def backwards(self, orm):
        
        # Changing field 'Song.playback_bass_ramp'
        db.alter_column('webview_song', 'playback_bass_ramp', self.gf('django.db.models.fields.CharField')(max_length=3))

        # Changing field 'Song.playback_bass_mode'
        db.alter_column('webview_song', 'playback_bass_mode', self.gf('django.db.models.fields.CharField')(max_length=3))
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 20, 21, 51, 25, 609215)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 20, 21, 51, 25, 596708)'}),
