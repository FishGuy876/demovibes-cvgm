...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('webview_userprofile', 'last_ip', self.gf('django.db.models.fields.IPAddressField')(default=None, max_length=15, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 23, 19, 0, 16, 334832)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.song': {
            ...
            'rnd': ('django.db.models.fields.IntegerField', [], {'default': '-1517148129', 'db_index': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 23, 19, 0, 16, 324177)'}),
