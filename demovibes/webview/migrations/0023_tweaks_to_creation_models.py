...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Artist.created_by'
        db.add_column('webview_artist', 'created_by', models.ForeignKey(orm['auth.User'], related_name="artist_createdby", null=True, blank=True))
        
        # Adding field 'Group.created_by'
        db.add_column('webview_group', 'created_by', models.ForeignKey(orm['auth.User'], related_name="group_createdby", null=True, blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Artist.created_by'
        db.delete_column('webview_artist', 'created_by_id')
        
        # Deleting field 'Group.created_by'
        db.delete_column('webview_group', 'created_by_id')
