...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Oneliner', fields ['added']
        db.create_index('webview_oneliner', ['added'])


    def backwards(self, orm):
        
        # Removing index on 'Oneliner', fields ['added']
        db.delete_index('webview_oneliner', ['added'])
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 22, 14, 28, 25, 497030)'}),
