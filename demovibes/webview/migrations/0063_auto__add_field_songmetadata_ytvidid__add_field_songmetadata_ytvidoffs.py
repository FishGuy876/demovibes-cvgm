...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SongMetaData.ytvidid'
        db.add_column('webview_songmetadata', 'ytvidid', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'SongMetaData.ytvidoffset'
        db.add_column('webview_songmetadata', 'ytvidoffset', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'SongMetaData.pouetid'
        db.add_column('webview_songmetadata', 'pouetid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding index on 'SongMetaData', fields ['active']
        db.create_index('webview_songmetadata', ['active'])


    def backwards(self, orm):
        
        # Removing index on 'SongMetaData', fields ['active']
        db.delete_index('webview_songmetadata', ['active'])

        # Deleting field 'SongMetaData.ytvidid'
        db.delete_column('webview_songmetadata', 'ytvidid')

        # Deleting field 'SongMetaData.ytvidoffset'
        db.delete_column('webview_songmetadata', 'ytvidoffset')

        # Deleting field 'SongMetaData.pouetid'
        db.delete_column('webview_songmetadata', 'pouetid')
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 28, 22, 11, 41, 41240)'}),
