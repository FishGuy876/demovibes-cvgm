...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CompilationSongList.num'
        db.delete_column('webview_compilationsonglist', 'num')

        # Adding field 'CompilationSongList.index'
        db.add_column('webview_compilationsonglist', 'index', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Removing M2M table for field songs on 'Compilation'
        db.delete_table('webview_compilation_songs')


    def backwards(self, orm):
        
        # Adding field 'CompilationSongList.num'
        db.add_column('webview_compilationsonglist', 'num', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Deleting field 'CompilationSongList.index'
        db.delete_column('webview_compilationsonglist', 'index')

        # Adding M2M table for field songs on 'Compilation'
        db.create_table('webview_compilation_songs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('compilation', models.ForeignKey(orm['webview.compilation'], null=False)),
            ('song', models.ForeignKey(orm['webview.song'], null=False))
        ))
        db.create_unique('webview_compilation_songs', ['compilation_id', 'song_id'])
    ...
    models = {
        ...
        'webview.compilationsonglist': {
            'Meta': {'object_name': 'CompilationSongList'},
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 25, 4, 3, 54, 948921)'}),
