...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GenericBaseLink'
        db.create_table('webview_genericbaselink', (
            ...
            ('inputinfo', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('regex', self.gf('django.db.models.fields.TextField')()),
            ('linktype', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal('webview', ['GenericBaseLink'])

        # Adding model 'GenericLink'
        db.create_table('webview_genericlink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webview.GenericBaseLink'])),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('webview', ['GenericLink'])


    def backwards(self, orm):
        
        # Deleting model 'GenericBaseLink'
        db.delete_table('webview_genericbaselink')

        # Deleting model 'GenericLink'
        db.delete_table('webview_genericlink')
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 5, 12, 41, 15, 469375)'}),
