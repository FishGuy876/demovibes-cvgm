...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SongLicense'
        db.create_table('webview_songlicense', (
            ...
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, unique=True, blank=True)),
            ('downloadable', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('webview', ['SongLicense'])

        # Adding field 'Song.license'
        db.add_column('webview_song', 'license', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['webview.SongLicense'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'SongLicense'
        db.delete_table('webview_songlicense')

        # Deleting field 'Song.license'
        db.delete_column('webview_song', 'license_id')
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 12, 13, 2, 26, 958182)'}),
