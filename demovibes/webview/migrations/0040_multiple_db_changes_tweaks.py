...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Compilation.comp_icon'
        db.add_column('webview_compilation', 'comp_icon', models.ImageField(null=True, upload_to='media/compilations/icons', blank=True))
        
        # Adding field 'Song.release_year'
        db.add_column('webview_song', 'release_year', models.CharField(max_length="4", blank=True, null=True, verbose_name="Release Year", db_index=True))
        
        # Adding field 'Label.label_icon'
        db.add_column('webview_label', 'label_icon', models.ImageField(verbose_name="Label Icon (Shows instead of default icon)", null=True, upload_to='media/labels/icons', blank=True))
        
        # Adding field 'Group.group_icon'
        db.add_column('webview_group', 'group_icon', models.ImageField(null=True, upload_to='media/groups/icons', blank=True))
        
        # Deleting field 'Song.release_date'
        db.delete_column('webview_song', 'release_date')
        
        # Changing field 'Userprofile.email_on_pm'
        db.alter_column('webview_userprofile', 'email_on_pm', models.BooleanField(default=True, verbose_name="Send email on new PM"))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Compilation.comp_icon'
        db.delete_column('webview_compilation', 'comp_icon')
        
        # Deleting field 'Song.release_year'
        db.delete_column('webview_song', 'release_year')
        
        # Deleting field 'Label.label_icon'
        db.delete_column('webview_label', 'label_icon')
        
        # Deleting field 'Group.group_icon'
        db.delete_column('webview_group', 'group_icon')
        
        # Adding field 'Song.release_date'
        db.add_column('webview_song', 'release_date', models.DateField(null=True, verbose_name="Release Date", blank=True))
        
        # Changing field 'Userprofile.email_on_pm'
        db.alter_column('webview_userprofile', 'email_on_pm', models.BooleanField(default=False, verbose_name="Send email on new PM"))
