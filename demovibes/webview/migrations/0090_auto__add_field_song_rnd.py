...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.rnd'
        db.add_column('webview_song', 'rnd', self.gf('django.db.models.fields.IntegerField')(default=109840518), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Song.rnd'
        db.delete_column('webview_song', 'rnd')
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 26, 11, 52, 5, 668166)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.song': {
            ...
            'rnd': ('django.db.models.fields.IntegerField', [], {'default': '852002761'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 26, 11, 52, 5, 654751)'}),
