...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Song.pouetlink'
        db.alter_column('webview_song', 'pouetlink', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Song.pouetlink'
        db.alter_column('webview_song', 'pouetlink', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 17, 2, 21, 42, 321101)'}),
