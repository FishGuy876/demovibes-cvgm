...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Userprofile.hol_id'
        db.add_column('webview_userprofile', 'hol_id', models.IntegerField(null=True, verbose_name="H.O.L. ID", blank=True))
        
        # Adding field 'Compilation.hol_id'
        db.add_column('webview_compilation', 'hol_id', models.IntegerField(null=True, verbose_name="H.O.L. ID", blank=True))
        
        # Adding field 'Song.hol_id'
        db.add_column('webview_song', 'hol_id', models.IntegerField(null=True, verbose_name="H.O.L. ID", blank=True))
        
        # Adding field 'Artist.hol_id'
        db.add_column('webview_artist', 'hol_id', models.IntegerField(null=True, verbose_name="H.O.L. ID", blank=True))
        
        # Adding field 'Label.hol_id'
        db.add_column('webview_label', 'hol_id', models.IntegerField(null=True, verbose_name="H.O.L. ID", blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Userprofile.hol_id'
        db.delete_column('webview_userprofile', 'hol_id')
        
        # Deleting field 'Compilation.hol_id'
        db.delete_column('webview_compilation', 'hol_id')
        
        # Deleting field 'Song.hol_id'
        db.delete_column('webview_song', 'hol_id')
        
        # Deleting field 'Artist.hol_id'
        db.delete_column('webview_artist', 'hol_id')
        
        # Deleting field 'Label.hol_id'
        db.delete_column('webview_label', 'hol_id')
