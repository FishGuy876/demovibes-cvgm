...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('webview_radiostream', 'country_code', self.gf('webview.models.CountryField')(max_length=10))

        # Changing field 'Artist.home_country'
        db.alter_column('webview_artist', 'home_country', self.gf('webview.models.CountryField')(max_length=10))

        # Changing field 'Userprofile.country'
        db.alter_column('webview_userprofile', 'country', self.gf('webview.models.CountryField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'RadioStream.country_code'
        db.alter_column('webview_radiostream', 'country_code', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Artist.home_country'
        db.alter_column('webview_artist', 'home_country', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Userprofile.country'
        db.alter_column('webview_userprofile', 'country', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'webview.artist': {
            ...
            'home_country': ('webview.models.CountryField', [], {'max_length': '10', 'blank': 'True'}),
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 14, 13, 3, 44, 753161)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.radiostream': {
            ...
            'country_code': ('webview.models.CountryField', [], {'max_length': '10'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'webview.song': {
            ...
            'rnd': ('django.db.models.fields.IntegerField', [], {'default': '1211354653', 'db_index': 'True'}),
        ...
        'webview.songtype': {
            ...
            'compilation_expected': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'symbol': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'country': ('webview.models.CountryField', [], {'max_length': '10', 'blank': 'True'}),
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 14, 13, 3, 44, 737831)'}),
