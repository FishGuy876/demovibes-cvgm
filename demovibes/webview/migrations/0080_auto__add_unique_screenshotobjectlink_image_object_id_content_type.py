...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ScreenshotObjectLink', fields ['image', 'object_id', 'content_type']
        db.create_unique('webview_screenshotobjectlink', ['image_id', 'object_id', 'content_type_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ScreenshotObjectLink', fields ['image', 'object_id', 'content_type']
        db.delete_unique('webview_screenshotobjectlink', ['image_id', 'object_id', 'content_type_id'])
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 20, 17, 30, 139177)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 2, 20, 17, 30, 121408)'}),
