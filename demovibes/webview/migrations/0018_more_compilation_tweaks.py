...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Compilation.status'
        db.add_column('webview_compilation', 'status', models.CharField(default='A', max_length=1))
        
        # Adding field 'Compilation.created_by'
        db.add_column('webview_compilation', 'created_by', models.ForeignKey(orm['auth.User'], null=True, blank=True))
        
        # Adding ManyToManyField 'Compilation.songs'
        ...
        # Dropping ManyToManyField 'Song.compilations'
        db.delete_table('webview_song_compilations')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Compilation.status'
        db.delete_column('webview_compilation', 'status')
        
        # Deleting field 'Compilation.created_by'
        db.delete_column('webview_compilation', 'created_by_id')
        
        # Dropping ManyToManyField 'Compilation.songs'
        db.delete_table('webview_compilation_songs')
        
        # Adding ManyToManyField 'Song.compilations'
        db.create_table('webview_song_compilations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('song', models.ForeignKey(Song, null=False)),
            ('compilation', models.ForeignKey(compilation, null=False))
        ))
