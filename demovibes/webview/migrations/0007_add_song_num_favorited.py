...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.num_favorited'
        db.add_column('webview_song', 'num_favorited', models.IntegerField(default=0))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Song.num_favorited'
        db.delete_column('webview_song', 'num_favorited')
