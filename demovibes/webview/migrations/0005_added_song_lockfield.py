...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.locked_until'
        db.add_column('webview_song', 'locked_until', models.DateTimeField(null=True, blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Song.locked_until'
        db.delete_column('webview_song', 'locked_until')
