...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('webview_song', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=256))

        # Changing field 'Song.title'
        db.alter_column('webview_song', 'title', self.gf('django.db.models.fields.CharField')(max_length=128))


    def backwards(self, orm):
        
        # Changing field 'Song.file'
        db.alter_column('webview_song', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=200))

        # Changing field 'Song.title'
        db.alter_column('webview_song', 'title', self.gf('django.db.models.fields.CharField')(max_length=80))
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 11, 9, 13, 20, 655241)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.song': {
            ...
            'rnd': ('django.db.models.fields.IntegerField', [], {'default': '-290171240', 'db_index': 'True'}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 11, 9, 13, 20, 635403)'}),
