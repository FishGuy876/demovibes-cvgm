...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Artist.last_fm_id'
        db.add_column('webview_artist', 'last_fm_id', models.CharField(max_length=32, verbose_name="ID/Name of artist's Last.fm account (without the URL)", blank=True))
        
        # Adding field 'Song.remix_of_id'
        db.add_column('webview_song', 'remix_of_id', models.IntegerField(null=True, verbose_name='SongID of original song this entry is mixed from, if a remix', blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Artist.last_fm_id'
        db.delete_column('webview_artist', 'last_fm_id')
    ...
    models = {
        ...
        'webview.song': {
            ...
            'remix_of_id': ('models.IntegerField', [], {'null': 'True', 'verbose_name': "'SongID of original song this entry is mixed from, if a remix'", 'blank': 'True'}),
        ...
        'webview.artist': {
            ...
            'id': ('models.AutoField', [], {'primary_key': 'True'}),
            'info': ('models.TextField', [], {'blank': 'True'}),
            'last_fm_id': ('models.CharField', [], {'max_length': '32', 'verbose_name': '"ID/Name of artist\'s Last.fm account (without the URL)"', 'blank': 'True'}),
            'last_updated': ('models.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
