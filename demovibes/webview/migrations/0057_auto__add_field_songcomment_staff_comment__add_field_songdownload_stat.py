...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SongComment.staff_comment'
        db.add_column('webview_songcomment', 'staff_comment', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'SongDownload.status'
        db.add_column('webview_songdownload', 'status', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'GenericLink.status'
        db.add_column('webview_genericlink', 'status', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SongComment.staff_comment'
        db.delete_column('webview_songcomment', 'staff_comment')

        # Deleting field 'SongDownload.status'
        db.delete_column('webview_songdownload', 'status')

        # Deleting field 'GenericLink.status'
        db.delete_column('webview_genericlink', 'status')
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 7, 23, 35, 43, 709125)'}),
