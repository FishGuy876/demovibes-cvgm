...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Song.pouetlink'
        db.add_column('webview_song', 'pouetlink', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Song.pouetss'
        db.add_column('webview_song', 'pouetss', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Song.pouetgroup'
        db.add_column('webview_song', 'pouetgroup', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Song.pouettitle'
        db.add_column('webview_song', 'pouettitle', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Song.pouetlink'
        db.delete_column('webview_song', 'pouetlink')

        # Deleting field 'Song.pouetss'
        db.delete_column('webview_song', 'pouetss')

        # Deleting field 'Song.pouetgroup'
        db.delete_column('webview_song', 'pouetgroup')

        # Deleting field 'Song.pouettitle'
        db.delete_column('webview_song', 'pouettitle')
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 22, 22, 1, 36, 811522)'}),
