...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.alter_column('webview_news', 'added', models.DateTimeField(auto_now_add=True, db_index=True))
        
        # Changing field 'RadioStream.active'
        db.alter_column('webview_radiostream', 'active', models.BooleanField(default=True, db_index=True))
        
        # Changing field 'Group.pouetid'
        db.alter_column('webview_group', 'pouetid', models.IntegerField(null=True, verbose_name="Pouet ID", blank=True))
        
        # Changing field 'Group.name'
        db.alter_column('webview_group', 'name', models.CharField(unique=True, max_length=30, verbose_name="* Name", db_index=True))
        
        # Changing field 'Group.webpage'
        db.alter_column('webview_group', 'webpage', models.URLField(verbose_name="Website", blank=True))
        
        # Changing field 'Group.info'
        db.alter_column('webview_group', 'info', models.TextField(verbose_name="Group Info", blank=True))
        
        # Changing field 'Group.found_date'
        db.alter_column('webview_group', 'found_date', models.DateField(null=True, verbose_name="Found Date", blank=True))
        
        # Changing field 'Compilation.label'
        db.alter_column('webview_compilation', 'label', models.CharField(max_length=30, verbose_name="Prod. Label", blank=True))
        
        # Changing field 'Compilation.name'
        db.alter_column('webview_compilation', 'name', models.CharField(unique=True, max_length=30, verbose_name="* Name", db_index=True))
        
        # Changing field 'Label.pouetid'
        db.alter_column('webview_label', 'pouetid', models.IntegerField(null=True, verbose_name="Pouet ID", blank=True))
        
        # Changing field 'Label.name'
        db.alter_column('webview_label', 'name', models.CharField(unique=True, max_length=40, verbose_name="* Name", db_index=True))
        
        # Changing field 'Label.webpage'
        db.alter_column('webview_label', 'webpage', models.URLField(verbose_name="Website", blank=True))
        
        # Changing field 'Label.logo'
        db.alter_column('webview_label', 'logo', models.ImageField(verbose_name="Label Logo", null=True, blank=True))
        
        # Changing field 'Artist.handle'
        db.alter_column('webview_artist', 'handle', models.CharField(unique=True, max_length=64, verbose_name="* Handle", db_index=True))
        
        # Changing field 'Logo.active'
        db.alter_column('webview_logo', 'active', models.BooleanField(default=True, db_index=True))
        
        # Changing field 'PrivateMessage.visible'
        db.alter_column('webview_privatemessage', 'visible', models.BooleanField(default=True, db_index=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'News.added'
        db.alter_column('webview_news', 'added', models.DateTimeField(auto_now_add=True))
        
        # Changing field 'RadioStream.active'
        db.alter_column('webview_radiostream', 'active', models.BooleanField(default=True))
        
        # Changing field 'Group.pouetid'
        db.alter_column('webview_group', 'pouetid', models.IntegerField(null=True, blank=True))
        
        # Changing field 'Group.name'
        db.alter_column('webview_group', 'name', models.CharField(max_length=30, unique=True, db_index=True))
        
        # Changing field 'Group.webpage'
        db.alter_column('webview_group', 'webpage', models.URLField(blank=True))
        
        # Changing field 'Group.info'
        db.alter_column('webview_group', 'info', models.TextField(blank=True))
        
        # Changing field 'Group.found_date'
        db.alter_column('webview_group', 'found_date', models.DateField(null=True, blank=True))
        
        # Changing field 'Compilation.label'
        db.alter_column('webview_compilation', 'label', models.CharField(max_length=30, blank=True))
        
        # Changing field 'Compilation.name'
        db.alter_column('webview_compilation', 'name', models.CharField(max_length=30, unique=True, db_index=True))
        
        # Changing field 'Label.pouetid'
        db.alter_column('webview_label', 'pouetid', models.IntegerField(null=True, blank=True))
        
        # Changing field 'Label.name'
        db.alter_column('webview_label', 'name', models.CharField(max_length=40, unique=True, db_index=True))
        
        # Changing field 'Label.webpage'
        db.alter_column('webview_label', 'webpage', models.URLField(blank=True))
        
        # Changing field 'Label.logo'
        db.alter_column('webview_label', 'logo', models.ImageField(null=True, blank=True))
        
        # Changing field 'Artist.handle'
        db.alter_column('webview_artist', 'handle', models.CharField(max_length=64, unique=True, verbose_name="Handle", db_index=True))
        
        # Changing field 'Logo.active'
        db.alter_column('webview_logo', 'active', models.BooleanField(default=True))
        
        # Changing field 'PrivateMessage.visible'
        db.alter_column('webview_privatemessage', 'visible', models.BooleanField(default=True))
