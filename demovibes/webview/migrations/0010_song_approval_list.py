...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SongApprovals'
        db.create_table('webview_songapprovals', (
            ('approved', models.DateTimeField(auto_now_add=True)),
            ('uploaded_by', models.ForeignKey(orm['auth.User'], related_name="uploadlist_uploadedby")),
            ('approved_by', models.ForeignKey(orm['auth.User'], related_name="uploadlist_approvedby")),
            ('id', models.AutoField(primary_key=True)),
            ('song', models.ForeignKey(orm.Song)),
        ))
        db.send_create_signal('webview', ['SongApprovals'])
        
        # Changing field 'Song.song_length'
        db.alter_column('webview_song', 'song_length', models.IntegerField(null=True, blank=True))
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'SongApprovals'
        db.delete_table('webview_songapprovals')
        
        # Changing field 'Song.song_length'
        db.alter_column('webview_song', 'song_length', models.IntegerField(null=True, editable=False, blank=True))
