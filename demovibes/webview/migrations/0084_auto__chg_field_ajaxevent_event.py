...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AjaxEvent.event'
        db.alter_column('webview_ajaxevent', 'event', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'AjaxEvent.event'
        db.alter_column('webview_ajaxevent', 'event', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'webview.objectlog': {
            ...
            'added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 12, 23, 5, 23, 988900)'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 12, 23, 5, 23, 964978)'}),
