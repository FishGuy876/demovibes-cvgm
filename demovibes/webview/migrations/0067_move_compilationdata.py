...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for c in orm.Compilation.objects.all():
            for s in c.songs.all():
                orm.CompilationSongList.objects.create(compilation=c, song=s)
                print "Doing %s - %s" % (c.name, s.title)
    ...
    models = {
        ...
        'webview.userprofile': {
            ...
            'last_changed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 25, 3, 50, 17, 70256)'}),
