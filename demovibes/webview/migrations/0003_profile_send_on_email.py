...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Userprofile.email_on_pm'
        db.add_column('webview_userprofile', 'email_on_pm', models.BooleanField(default=False, verbose_name="Send email on new PM"))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Userprofile.email_on_pm'
        db.delete_column('webview_userprofile', 'email_on_pm')
